...
public class DetailsFragment extends Fragment implements View.OnClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        detailsImage = view.findViewById(R.id.detail_image);
        detailsTitle = view.findViewById(R.id.detail_title);
        detailsDesc = view.findViewById(R.id.detail_desc);
        detailsDiff = view.findViewById(R.id.detail_dificali_text);
        detailsQuestions = view.findViewById(R.id.detail_question_text);
        detailsScore = view.findViewById(R.id.detail_score_text);

        detailsStartBtn = view.findViewById(R.id.detail_start_button);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.detail_start_button:
                ...
                action.setTotalQuestirns(totalQuestions);
