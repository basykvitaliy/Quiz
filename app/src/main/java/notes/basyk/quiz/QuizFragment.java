...
public class QuizFragment extends Fragment implements View.OnClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        totalQuestionsToAnswer = QuizFragmentArgs.fromBundle(getArguments()).getTotalQuestirns();
        ...
        firebaseFirestore.collection("QuizList")
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    Log.d("SDV", "List " + allQuestionsList.get(0).getQuestion());
                    pickQuestions();
                    loadUI();
                } else {
    ...
    private void startTimer(int questNum) {
        //Set Timer Text
        final Long timeToAnswer = questionsToAnswer.get(questNum-1).getTimer();
        ...
        countDownTimer = new CountDownTimer(timeToAnswer*1000, 10) {
            ...
            public void onFinish() {
                ...
                questionFeedback.setText("Время вышло! Не выбрано ни одного ответа!");
    ...
    private void pickQuestions() {
        for (int i = 0; i < totalQuestionsToAnswer; i++) {
            ...
            Log.d("QUESTIONS", "Question " + i + " : " + questionsToAnswer.get(i).getQuestion());
        }
    }
    ...
    private void verifyAnswer(Button selectedAnswerBtn) {
        ...
        if(canAnswer){
            ...
            if(questionsToAnswer.get(currentQuestion-1).getAnswer().equals(selectedAnswerBtn.getText())){
                ...
                //Set Feedback Text
                questionFeedback.setText("Правильный ответ");
                questionFeedback.setTextColor(getResources().getColor(R.color.colorPrimary, null));
            } else {
                //Wrong Answer
                wrongAnswers++;
                ...
                //Set Feedback Text
                questionFeedback.setText("Неправильный ответ \n \n Правильный ответ: " + questionsToAnswer.get(currentQuestion-1).getAnswer());
